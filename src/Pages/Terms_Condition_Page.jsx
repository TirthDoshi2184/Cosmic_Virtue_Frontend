...
const sections = [
  ...
  },
  {
    ...
    title: 'Governing Law',
    content: [
      'These Terms and Conditions are governed by and construed in accordance with the laws of India. Any disputes arising out of or relating to these Terms shall be subject to the exclusive jurisdiction of the courts located in Surat, Gujarat, India.',
  ...
  },
  {
    ...
    cards: [
      { emoji: '✉️', label: 'General Enquiries', desc: 'hello@cosmicvirtues.com' },
      { emoji: '🛒', label: 'Order Support', desc: 'support@cosmicvirtues.com' },
      { emoji: '⚖️', label: 'Legal & Privacy', desc: 'privacy@cosmicvirtues.com' },
      { emoji: '📍', label: 'Location', desc: 'Surat, Gujarat, India' },
    ],
  },
];
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
            {['Effective: January 1, 2026', 'Jurisdiction: Surat, Gujarat, India', 'Version 1.0'].map((m) => (
              <span
                key={m}
